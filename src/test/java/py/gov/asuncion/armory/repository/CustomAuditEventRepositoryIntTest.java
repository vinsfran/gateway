package py.gov.asuncion.armory.repository;

import py.gov.asuncion.armory.ArmoryApp;
import py.gov.asuncion.armory.config.Constants;
import py.gov.asuncion.armory.config.audit.AuditEventConverter;
import py.gov.asuncion.armory.domain.PersistentAuditEvent;
...
import static py.gov.asuncion.armory.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
