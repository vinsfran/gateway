package py.gov.asuncion.armory.web.rest;

import py.gov.asuncion.armory.config.Constants;
import py.gov.asuncion.armory.ArmoryApp;
import py.gov.asuncion.armory.domain.Authority;
import py.gov.asuncion.armory.domain.User;
import py.gov.asuncion.armory.repository.AuthorityRepository;
import py.gov.asuncion.armory.repository.UserRepository;
import py.gov.asuncion.armory.security.AuthoritiesConstants;
import py.gov.asuncion.armory.service.MailService;
import py.gov.asuncion.armory.service.dto.UserDTO;
import py.gov.asuncion.armory.service.dto.PasswordChangeDTO;
import py.gov.asuncion.armory.web.rest.errors.ExceptionTranslator;
import py.gov.asuncion.armory.web.rest.vm.KeyAndPasswordVM;
import py.gov.asuncion.armory.web.rest.vm.ManagedUserVM;
import py.gov.asuncion.armory.service.UserService;
